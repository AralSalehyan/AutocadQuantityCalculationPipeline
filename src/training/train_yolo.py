...
def main() -> int:
    parser = argparse.ArgumentParser(description="Train YOLO door/window detector.")
    ...
    parser.add_argument("--project", type=Path, default=Path("models/yolo/runs"))
    ...
    target_path = Path("models/yolo/door_window.pt")
    if best_path.exists():
